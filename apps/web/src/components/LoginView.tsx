    ...
    <div className="min-h-screen bg-ink-950 text-text-primary flex flex-col justify-between relative">
      ...
      <main className="relative z-10 max-w-4xl w-full mx-auto px-6 sm:px-12 py-6">
        <div className="glass-panel overflow-hidden border border-slate-300 dark:border-white/[0.12] grid grid-cols-1 md:grid-cols-12 shadow-2xl bg-white dark:bg-ink-950/80">
          ...
          {/* Left Column: Header & Centered Shield with RATECAP Name */}
          <div className="md:col-span-5 p-8 bg-slate-50 dark:bg-ink-900/90 border-b md:border-b-0 md:border-r border-slate-200 dark:border-white/[0.08] flex flex-col justify-between space-y-6 relative overflow-hidden">
            ...
            {/* Centered RateCap Shield with RATECAP Name Below */}
            <div className="flex-1 flex flex-col items-center justify-center text-center my-auto py-8 space-y-3.5">
              <div className="relative group">
                ...
                <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-3xl bg-gradient-to-br from-signal-indigo via-[#4D51E8] to-signal-teal p-[2px] shadow-2xl transition-transform duration-300 group-hover:scale-105">
              ...
              {/* RATECAP Name directly below shield */}
              <div className="font-display font-bold text-lg sm:text-xl text-black dark:text-white tracking-widest uppercase">
                RATECAP
              </div>
            </div>
          </div>
